 ...
 */
namespace Share_On_Twitter\Composer;

use Share_On_Twitter\Composer\Autoload\ClassLoader;
use Share_On_Twitter\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Share_On_Twitter\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
